...
void CutscenePlayer::Register()
{
    ...
    InterpolationOnCommand = GetCommandId("interpol_on", true);
    InterpolationOffCommand = GetCommandId("interpol_off", true);
    InterpolationOffFrameCommand = GetCommandId("interpol_off_frame", true);
