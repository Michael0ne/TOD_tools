...
public:
    ...
    virtual uint32_t    GetDataSize(uint32_t* ptr) override; // @47AD60
    ...
    virtual const int   GetUsedBlocksTotal() const override; // @47AD70
    virtual const int   GetFreeBlocksTotal() const override; // @47AD70
    virtual const int   GetBiggestUsedMemoryBlock() const override; // @47AD90
