...
public:
 ...
 virtual void*    Allocate_A(size_t size, int filler, int unk) override; // @479830
 virtual void*    AllocateAligned(size_t size, size_t alignment, int filler, int unk) override; // @479C40
 virtual void    Free(void* ptr) override; // @479A10
 virtual void    FreeAligned(void* ptr) override; // @479850
 virtual void*    Realloc(void* oldptr, size_t newsize, int filler, int unk) override; // @479DA0
