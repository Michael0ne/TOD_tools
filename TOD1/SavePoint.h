...
public:
    ...
    static int      CalculateChecksum(SavePoint* savepoint, int pos); // @874180
    static bool     GenerateAndWriteCRC(SavePoint* sp, const int pos);    //  @874310
    static bool     VerifyFileChecksum(SavePoint* sp); // @874230

    static int  OpenFilesCount; // @A35EA8
};

ASSERT_CLASS_SIZE(SavePoint, 64);