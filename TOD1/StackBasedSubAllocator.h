...
protected:
    StackElement   *StackCurrentPtr;
    StackElement   *StackBeginPtr;
...
public:
    ...
    virtual uint32_t    GetDataSize(uint32_t* ptr) override; // @47AAA0
    ...
    virtual const int   GetUsedBlocksTotal() const override; // @47AAE0
    virtual const int   GetFreeBlocksTotal() const override; // @47AAF0
    virtual const int   GetBiggestUsedMemoryBlock() const override; // @47AB10
