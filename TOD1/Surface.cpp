...
{
    uint32_t pixelOffset = x + y * m_TextureWidth;
    uint8_t* pixelColorData = (uint8_t*)ALIGN_4BYTES(m_SurfacePixels);

    pixelColorData[pixelOffset++] = (uint8_t)(clr.a * 255.f);
    pixelColorData[pixelOffset++] = (uint8_t)(clr.r * 255.f);
    pixelColorData[pixelOffset++] = (uint8_t)(clr.g * 255.f);
    pixelColorData[pixelOffset++] = (uint8_t)(clr.b * 255.f);
}
