...
#define CHARACTER_PLACEHOLDER_CLASS_SIZE 160

enum E_CHARACTER_PLACEHOLDER_FLAGS
{
	//	TODO: there are A LOT of flags for this class that need to be described!
};
...
public:
	CharacterPlaceHolder() : Node(NODE_MASK_POSITION | NODE_MASK_QUADTREE)	//	NOTE: no constructor.
	{
...
static_assert(sizeof(CharacterPlaceHolder) == CHARACTER_PLACEHOLDER_CLASS_SIZE, MESSAGE_WRONG_CLASS_SIZE(CharacterPlaceHolder));