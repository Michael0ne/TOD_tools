...
public:
    ...
    static int     *RewindBuffer1DataPtr; // @A3CEE4 //  NOTE:   it looks like this stores entities properties with format (int, int*), 
    ...
    static int     *RewindBuffer2DataPtr; // @A3CEE8 //  NOTE: this and above are allocated and tied to transaction buffer.
